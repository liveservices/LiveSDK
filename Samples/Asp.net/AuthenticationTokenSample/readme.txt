The code included in this sample show how an application can extract the user identifier from an authentication token obtained 
through Live Connect’s OAuth endpoint.  For learn more about Live Connect, please visit http://msdn.microsoft.com/en-us/library/bb264574.aspx. To learn about OAuth 2.0 web authentication protocol, the specification can be found at http://tools.ietf.org/html/draft-ietf-oauth-v2-21.
