...
through Live Connect’s OAuth endpoint.  For learn more about Live Connect, please visit 

http://msdn.microsoft.com/en-us/library/bb264574.aspx. To learn about OAuth 2.0 web authentication protocol, the specification 

can be found at http://tools.ietf.org/html/draft-ietf-oauth-v2-21.
...
produce a per app unique identifier for the signed in user.  This unique identifier is exposed via the 

JsonWebToken.Claims.UserId property.
