...
/**
 * Implementation of the X-MESSENGER-OAUTH2 mechanism This mechanism is used for
 * SASL authentication with Windows Live Messenger service. The OAuth2.0 access
 * token is passed as is for authentication. For more information on Windows
 * Live OAuth2.0 see <link>
 * 
 */
